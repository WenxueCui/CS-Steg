...
optimizerG = optim.Adam(netG.parameters(), lr=0.00003)
...
for epoch in range(LOAD_EPOCH+1, NUM_EPOCHS + 1):
    ...
    save_dir = 'pre_epochs_rate_control_' + str(RATE_CONTROL) + '_SQ_Color_Gray' + '_subrate_' + str(opt.sub_rate) + '_meas_rate_control_' + str(MEAS_RATE_CONTROL)
